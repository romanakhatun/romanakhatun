    ...
    <section id="about" className="pt-35">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="font-body text-base text-base-content/90 leading-relaxed">
            As a{" "}
          ...
          <p className="font-body text-base-content/80 leading-relaxed">
            With expertise in{" "}
          ...
          <div className="relative pl-6 py-2 border-l-4 rounded-r-lg border-primary bg-primary/5 mt-8 overflow-hidden group">
            <div className="absolute top-0 right-0 pr-3 opacity-10 group-hover:scale-110 transition-transform">
              <svg
                width="40"
                height="40"
                viewBox="0 0 24 24"
            ...
            <p className="font-body text-neutral font-medium italic leading-relaxed relative z-10">
        ...
        <div className="lg:col-span-5">
          <div className="p-8 rounded-2xl border border-base-300 bg-base-100/50 backdrop-blur-sm relative overflow-hidden group">
            {/* Background Decorative Element */}
            <div className="absolute -right-10 -top-10 w-32 h-32 bg-primary/10 blur-3xl rounded-full group-hover:bg-primary/20 transition-colors duration-500"></div>

            <h3 className="font-title text-xl mb-6 uppercase tracking-wider">
              Fast Facts
            </h3>
