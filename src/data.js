const data = [
  {
    ...
    link: "https://power-x-gym-468fb.web.app",
  ...
  },
  {
    ...
    image: "/images/projects/brown-girl-book-lover.png",
    des: "A Book Library Website, Add Newsletter, Download Story System, Grid Use ",
    technology: "NEXT.JS - RE.DESIGN - sass - vercel",
    link: "https://brown-girl-book-lover.vercel.app",
    githubLink: "https://github.com/romanakhatun/brown-girl-book-lover",
  },
  {
    name: "Air Cnc",
    image: "/images/projects/air-cnc.png",
    des: "Google Web Fonts Included, Dynamic Header, Search Terms, 2 Step Data Filtration",
    technology: "React - JavaScript - Sass - Firebase - Google Analytics",
    link: "https://github.com/romanakhatun/air-cnc",
    githubLink: "https://air-cnc-r.web.app",
  },
];
export default data;
